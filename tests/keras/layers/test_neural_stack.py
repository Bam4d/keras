...
def _runner(layer_class, nb_samples, vector_size, timesteps, input_dim, output_dim):

    for ret_seq in [True, False]:
        layer = NeuralStack(layer_class, output_dim, vector_size, nb_samples, weights=None, return_sequences=ret_seq, input_shape=(timesteps, input_dim))
    ...
    # check statefulness
    layer = NeuralStack(layer_class, output_dim, vector_size, nb_samples, weights=None, return_sequences=False, batch_input_shape=(nb_samples, timesteps, input_dim))
...
def test_neural_stack_with_controller():
    ...
    _runner(SimpleRNN, batch_size, vector_size, time_steps, input_dim, output_dim)
